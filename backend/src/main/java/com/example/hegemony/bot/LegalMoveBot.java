...
public class LegalMoveBot {
    ...
    private String explain(GameCommand command, int legalCount) {
        ...
        String reason = switch (action) {
            ...
            case DRAW_VOTING_CUBES -> "The bot draws a legal number of cubes from the voting bag before influence commitments.";
            ...
            case BUILD_ENTERPRISE,
                 ...
                 MEET_DEPUTIES,
                 INTRODUCE_EXTRA_TAX,
                 RUN_CAMPAIGN -> "The bot uses a legal state/capitalist MVP action generated by the rules engine.";
