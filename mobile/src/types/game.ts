...
export interface GameState {
  ...
  productionPhaseState?: Record<string, unknown>;
  lastProductionSummary?: Record<string, unknown>;
  currentRound: number;
  ...
  gameOver: boolean;
  lastPreparationSummary?: Record<string, unknown>;
  lastScoringSummary?: Record<string, unknown>;
  scoringBreakdown: Array<Record<string, unknown>>;
  lastRoundSummary?: Record<string, unknown>;
  ...
  stateEventCards: Array<Record<string, unknown>>;
